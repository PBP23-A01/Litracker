...
from upvote_book.views import get_upvoted_books, upvote_book, toggle_upvote_flutter, get_upvoting_users, get_top_books, unvote_flutter
...
urlpatterns = [
    ...
    path('unvote_flutter/<int:book_id>/', unvote_flutter, name='unvote_flutter'),   
    ...
    path('get_top_books/', get_top_books, name='get_top_books'),
]